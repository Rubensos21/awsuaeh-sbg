...
const UPCOMING_EVENTS: EventItem[] = [
  {
    ...
    title: 'Cloud Architecture 101: De Cero a Serverless',
    description: 'Aprende los fundamentos de AWS Lambda, API Gateway y DynamoDB. Diseña y despliega tu primera API serverless completamente funcional, escalable y sin gestionar servidores.',
    modality: 'Presencial',
    location: 'Aula Magna ESTL, UAEH Tlahuelilpan',
  ...
  },
  {
    ...
    title: 'IA Generativa en la Nube con Amazon Bedrock',
    description: 'Explora cómo integrar Foundation Models de Anthropic y Meta utilizando Amazon Bedrock para construir asistentes inteligentes, análisis multimodal y aplicaciones RAG enterprise.',
    modality: 'Virtual',
    location: 'Discord / Teams UAEH SBG',
  ...
  },
  {
    ...
    tag: 'certificación',
    tagColor: '#43B4FF',
    tagBg: 'rgba(67, 180, 255, 0.12)',
    title: 'Ruta de Certificación: AWS Certified Cloud Practitioner (CLF-C02)',
    description: 'Bootcamp intensivo de preparación, arquitectura conceptual, tips de examen, vouchers de descuento y simulación de reactivos clave para certificar tus habilidades cloud.',
    modality: 'Híbrido',
    location: 'Laboratorio 3 ESTL & Streaming Live',
