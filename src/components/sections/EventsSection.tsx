...
const UPCOMING_EVENTS: EventItem[] = [
  ...
  },
  {
    ...
    description: 'Aprenderás los pilares clave de seguridad en AWS: Responsabilidad Compartida, IAM, menor privilegio, MFA, autenticación vs autorización, cifrado con KMS, y protección perimetral con WAF y Shield.',
    modality: 'Hibrido',
    ...
    description: 'Veremos diseño de redes en AWS: VPC, subredes públicas/privadas, enrutamiento, Route 53, CloudFront, y los conceptos de Zonas de Disponibilidad y Edge Locations.',
    modality: 'Hibrido',
    location: 'Online | Escuela Superior de Tlahuelilpan (ESTl), Hidalgo',
